...
interface ImageCardRightClickMenuProps {
  open: boolean
  close: () => void
...
function RightClickMenu(props: ImageCardRightClickMenuProps): React.ReactElement {
    const { open, close, download, openPreview, anchorElement, del, name, favorite, copy, onDeleteClick, deleteItemOpen, closeDelete } = props

    return (
        <React.Fragment>
            <Menu aria-label="image context menu" role="menu" anchorEl={anchorElement} open={open} onClose={close}>
                <MenuItem onClick={() => { openPreview(); close() }} aria-label="open image">
                    <ListItemIcon><PreviewIcon /></ListItemIcon>
                    <ListItemText>Open</ListItemText>
                </MenuItem>
                <Divider />
                <MenuItem onClick={download} aria-label="download image">
                    <ListItemIcon><DownloadForOfflineIcon /></ListItemIcon>
                    <ListItemText>Download</ListItemText>
                </MenuItem>
                <Divider />
                <MenuItem onClick={favorite} aria-label="favorite image">
...
function ImageCard(props: ImageCardProps): React.ReactElement {
    ...
    const source = `${connectionString}${props.data.FullPath}`
    const alt = `${props.data.name} thumbnail`
