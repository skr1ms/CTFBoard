...
import type { ProfileSettings } from '../types/context'
...
function SettingsDialog(props: DialogProps): React.ReactElement {
    const { open, close } = props
    const profile = React.useContext(ProfileContext)

    function updateSettings(setting: keyof ProfileSettings, value: boolean): void {
    ...
    return (
        ...
        >
            <DialogTitle sx={{ position: 'relative' }}>
                <Typography component="span" variant="h4">Settings</Typography>
                <IconButton
                    onClick={close}
                    aria-label="close"
                    sx={{
