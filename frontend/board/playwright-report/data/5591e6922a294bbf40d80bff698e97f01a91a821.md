...
- Name: admin-content.spec.ts >> Admin: notifications >> list renders seeded global notification
- Location: e2e/specs/admin-content.spec.ts:67:3
...
Locator: getByText('Welcome to E2E CTF')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('Welcome to E2E CTF')
