...
- Name: banned.spec.ts >> Banned: landing page >> banned page shows reason and date
- Location: e2e/specs/banned.spec.ts:12:3
...
Locator: getByText(/E2E banned fixture/i)
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for getByText(/E2E banned fixture/i)
