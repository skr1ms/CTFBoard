...
- Name: banned.spec.ts >> Banned: sign out >> sign out clears session
- Location: e2e/specs/banned.spec.ts:53:3
...
Received string:  "http://localhost:4173/banned"
Timeout: 10000ms

Call log:
  - Expect "toHaveURL" with timeout 10000ms
    14 × unexpected value "http://localhost:4173/banned"
