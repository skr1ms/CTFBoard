...
type (
	...
	SolveRepository interface {
		...
		GetModerationAffectedChallengeIDsByTeamID(ctx context.Context, teamID uuid.UUID) ([]uuid.UUID, error)
		GetModerationAffectedChallengeIDsByTeamAndUserID(ctx context.Context, teamID, userID uuid.UUID) ([]uuid.UUID, error)
		GetModerationAffectedSolvesByUserID(ctx context.Context, userID uuid.UUID) ([]*domain.ModerationAffectedSolve, error)
		GetModerationAffectedSolvesByBannedUserID(ctx context.Context, userID uuid.UUID) ([]*domain.ModerationAffectedSolve, error)
