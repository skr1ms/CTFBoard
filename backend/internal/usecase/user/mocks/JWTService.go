...
// RevokeAllForUser provides a mock function for the type MockJWTService
func (_mock *MockJWTService) RevokeAllForUser(ctx context.Context, userID uuid.UUID) error {
...
// MockJWTService_RevokeAllForUser_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RevokeAllForUser'
type MockJWTService_RevokeAllForUser_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - userID uuid.UUID
func (_e *MockJWTService_Expecter) RevokeAllForUser(ctx interface{}, userID interface{}) *MockJWTService_RevokeAllForUser_Call {
	return &MockJWTService_RevokeAllForUser_Call{Call: _e.mock.On("RevokeAllForUser", ctx, userID)}
}

func (_c *MockJWTService_RevokeAllForUser_Call) Run(run func(ctx context.Context, userID uuid.UUID)) *MockJWTService_RevokeAllForUser_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockJWTService_RevokeAllForUser_Call) Return(err error) *MockJWTService_RevokeAllForUser_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockJWTService_RevokeAllForUser_Call) RunAndReturn(run func(ctx context.Context, userID uuid.UUID) error) *MockJWTService_RevokeAllForUser_Call {
	_c.Call.Return(run)
	return _c
}
