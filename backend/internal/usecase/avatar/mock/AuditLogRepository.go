...
func (_mock *MockAuditLogRepository) Create(ctx context.Context, log *domain.AuditLog) error {
...
func (_c *MockAuditLogRepository_Create_Call) Run(run func(ctx context.Context, log *domain.AuditLog)) *MockAuditLogRepository_Create_Call {
...
func (_c *MockAuditLogRepository_Create_Call) RunAndReturn(run func(ctx context.Context, log *domain.AuditLog) error) *MockAuditLogRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
