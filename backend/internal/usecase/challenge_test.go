...
func TestChallengeUseCase_GetAll(t *testing.T) {
	...
	uc := NewChallengeUseCase(challengeRepo, solveRepo)
...
func TestChallengeUseCase_Create(t *testing.T) {
	...
	challenge, err := uc.Create(context.Background(), "New Challenge", "Description", "Crypto", 200, "flag{test}", false)
...
func TestChallengeUseCase_Update(t *testing.T) {
	...
	challenge, err := uc.Update(context.Background(), challengeID, "Updated Title", "Updated Description", "Crypto", 150, "", false)
...
func TestChallengeUseCase_Update_WithNewFlag(t *testing.T) {
	...
	challenge, err := uc.Update(context.Background(), challengeID, "Updated Title", "Updated Description", "Crypto", 150, "new_flag", false)
...
func TestChallengeUseCase_VerifyFlag_Success(t *testing.T) {
	...
	solveRepo.On("Create", mock.Anything, mock.MatchedBy(func(s *entity.Solve) bool {
...
func TestChallengeUseCase_VerifyFlag_CreateError(t *testing.T) {
	...
	challengeRepo.On("GetByID", mock.Anything, challengeID).Return(challenge, nil)
	solveRepo.On("GetByTeamAndChallenge", mock.Anything, teamID, challengeID).Return(nil, entityError.ErrSolveNotFound)
	solveRepo.On("Create", mock.Anything, mock.Anything).Return(expectedError)
