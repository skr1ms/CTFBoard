...
func (_mock *MockCommentRepository) Create(ctx context.Context, comment *domain.Comment) error {
...
func (_c *MockCommentRepository_Create_Call) Run(run func(ctx context.Context, comment *domain.Comment)) *MockCommentRepository_Create_Call {
...
func (_c *MockCommentRepository_Create_Call) RunAndReturn(run func(ctx context.Context, comment *domain.Comment) error) *MockCommentRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockCommentRepository) GetAll(ctx context.Context) ([]*domain.Comment, error) {
	...
	if returnFunc, ok := ret.Get(0).(func(context.Context) []*domain.Comment); ok {
		r0 = returnFunc(ctx)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockCommentRepository_GetAll_Call) Return(comments []*domain.Comment, err error) *MockCommentRepository_GetAll_Call {
	_c.Call.Return(comments, err)
	return _c
}

func (_c *MockCommentRepository_GetAll_Call) RunAndReturn(run func(ctx context.Context) ([]*domain.Comment, error)) *MockCommentRepository_GetAll_Call {
	_c.Call.Return(run)
	return _c
}

// GetByChallengeID provides a mock function for the type MockCommentRepository
func (_mock *MockCommentRepository) GetByChallengeID(ctx context.Context, challengeID uuid.UUID) ([]*domain.Comment, error) {
...
func (_c *MockCommentRepository_GetByChallengeID_Call) Return(comments []*domain.Comment, err error) *MockCommentRepository_GetByChallengeID_Call {
	_c.Call.Return(comments, err)
	return _c
}

func (_c *MockCommentRepository_GetByChallengeID_Call) RunAndReturn(run func(ctx context.Context, challengeID uuid.UUID) ([]*domain.Comment, error)) *MockCommentRepository_GetByChallengeID_Call {
	_c.Call.Return(run)
	return _c
}

// GetByID provides a mock function for the type MockCommentRepository
func (_mock *MockCommentRepository) GetByID(ctx context.Context, ID uuid.UUID) (*domain.Comment, error) {
	ret := _mock.Called(ctx, ID)
...
func (_c *MockCommentRepository_GetByID_Call) RunAndReturn(run func(ctx context.Context, ID uuid.UUID) (*domain.Comment, error)) *MockCommentRepository_GetByID_Call {
	_c.Call.Return(run)
	return _c
}

// Update provides a mock function for the type MockCommentRepository
func (_mock *MockCommentRepository) Update(ctx context.Context, comment *domain.Comment) error {
	ret := _mock.Called(ctx, comment)
...
func (_c *MockCommentRepository_Update_Call) Run(run func(ctx context.Context, comment *domain.Comment)) *MockCommentRepository_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockCommentRepository_Update_Call) RunAndReturn(run func(ctx context.Context, comment *domain.Comment) error) *MockCommentRepository_Update_Call {
	_c.Call.Return(run)
	return _c
}
