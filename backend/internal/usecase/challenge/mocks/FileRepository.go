...
func (_mock *MockFileRepository) GetByLocation(ctx context.Context, location string) (*entity.File, error) {
	...
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) *entity.File); ok {
...
func (_c *MockFileRepository_GetByLocation_Call) Return(file *entity.File, err error) *MockFileRepository_GetByLocation_Call {
	_c.Call.Return(file, err)
	return _c
}
