...
func (siw *ServerInterfaceWrapper) GetAdminConfigsCategory(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "category", chi.URLParam(r, "category"), &category, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) GetAdminExport(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindQueryParameterWithOptions("form", true, false, "include_users", r.URL.Query(), &params.IncludeUsers, runtime.BindQueryParameterOptions{Type: "boolean", Format: ""})
	if err != nil {
	...
	err = runtime.BindQueryParameterWithOptions("form", true, false, "include_teams", r.URL.Query(), &params.IncludeTeams, runtime.BindQueryParameterOptions{Type: "boolean", Format: ""})
	if err != nil {
	...
	err = runtime.BindQueryParameterWithOptions("form", true, false, "include_solves", r.URL.Query(), &params.IncludeSolves, runtime.BindQueryParameterOptions{Type: "boolean", Format: ""})
	if err != nil {
	...
	err = runtime.BindQueryParameterWithOptions("form", true, false, "include_hint_unlocks", r.URL.Query(), &params.IncludeHintUnlocks, runtime.BindQueryParameterOptions{Type: "boolean", Format: ""})
	if err != nil {
	...
	err = runtime.BindQueryParameterWithOptions("form", true, false, "include_awards", r.URL.Query(), &params.IncludeAwards, runtime.BindQueryParameterOptions{Type: "boolean", Format: ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) GetAdminExportZip(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindQueryParameterWithOptions("form", true, false, "include_files", r.URL.Query(), &params.IncludeFiles, runtime.BindQueryParameterOptions{Type: "boolean", Format: ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) PostChallengesChallengeIDHintsHintIDUnlock(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "hintID", chi.URLParam(r, "hintID"), &hintID, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) GetScoreboard(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindQueryParameterWithOptions("form", true, false, "bracket", r.URL.Query(), &params.Bracket, runtime.BindQueryParameterOptions{Type: "string", Format: "uuid"})
	if err != nil {
