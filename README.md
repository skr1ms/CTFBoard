# Техническое задание на разработку платформы AstroCTFb

**License:** AstroCTFb is licensed under the Apache License 2.0. See the [LICENSE](LICENSE) file for details.
